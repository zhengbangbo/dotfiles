# ChangeLog
# 240105 - fork from https://github.com/Innei/dotfiles/blob/master/macos-setup.sh
sudo -v
...
# Note: I can't enable this(2024-01-05, macOS 13.6.3 (22G436) Inter chip)
...
cd
git clone git@github.com:zhengbangbo/dotfiles.git .dotfiles
rcup -t base
rcup -t git
rcup -t nvim-lazyvim
